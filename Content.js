...
//     alert("youtube hai bhai padhai karle");
// }
...
const generateHTML = (pageName) => {
    ...
    <div class='c'>
        ...
        <div class='_2'>PRODUCTIVITY > ${pageName}</div>
        <div class='_2'>&#169 Anhad Parashar</div>
    </div>`
};
...
switch (window.location.hostname) {
    ...
    case "www.omegle.com":
        document.head.innerHTML = generateSTYLES();
        document.body.innerHTML = generateHTML("OMEGLE");
